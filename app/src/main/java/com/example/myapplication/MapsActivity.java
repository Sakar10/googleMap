...
import com.example.myapplication.model.LatitudeLongitude;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        latLngs.add(new LatitudeLongitude(27.7061949, 85.3300394, "Mero college"));
        latLngs.add(new LatitudeLongitude(26.7226539, 87.6352896, "Morang"));
        latLngs.add(new LatitudeLongitude(27.6864673, 83.4291009, "Butwal"));
